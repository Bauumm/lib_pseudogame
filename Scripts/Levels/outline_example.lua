...
-- draw the outlines directly to the screen instead of filling up a collection
...
-- or restarted.
function onLoad()
    e_messageAdd("welcome to the tenth PseudoGame example level", 150)
    e_messageAdd("This one demonstrates the premade outline effect.", 200)
end
