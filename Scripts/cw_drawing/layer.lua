...
function layer:draw_extra_blend(blend_function, blend_layer)
	self:draw_transformed_extra(function(objects, x0, y0, x1, y1, x2, y2, x3, y3, r0, g0, b0, a0, r1, g1, b1, a1, r2, g2, b2, a2, r3, g3, b3, a3, collision, deadly, killing_side)
		local this_obj = {x0, y0, x1, y1, x2, y2, x3, y3, r0, g0, b0, a0, r1, g1, b1, a1, r2, g2, b2, a2, r3, g3, b3, a3, collision, deadly, killing_side}
		objects[#objects + 1] = this_obj
		local pts = {unpack(this_obj, 1, 8)}
		for x0, y0, x1, y1, x2, y2, x3, y3, r0, g0, b0, a0, r1, g1, b1, a1, r2, g2, b2, a2, r3, g3, b3, a3, collision, deadly, killing_side in blend_layer.container:iter() do
			...
			if #poly > 0 then
				...
				if clipped_polys ~= nil and #clipped_polys ~= 0 then
					local extra = {unpack(this_obj, 9, 24)}
					...
					for j=1, #clipped_polys do
						...
						objects[#objects + 1] = clipped_poly
					end
				end
			end
		end
